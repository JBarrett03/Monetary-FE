...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">monetary-fe documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AccountDetails.html" data-type="entity-link" >AccountDetails</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ManageAccounts.html" data-type="entity-link" >ManageAccounts</a>
                            </li>
                            <li class="link">
                                <a href="components/Navigation.html" data-type="entity-link" >Navigation</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/TestUserService.html" data-type="entity-link" >TestUserService</a>
                            </li>
                            <li class="link">
